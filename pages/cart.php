    ...
    <main>
        <section class="grid-section">
            ...
            <div class="hero has-before" id="home">
                <div class="container">
                    <h1 class="h1 title hero-title">Shopping Cart</h1>
        ...
        <p class="section-text" data-reveal="bottom">
            You can now shop directly from this website or visit our physical shop in Nairobi.
            Scroll left-right to view some of the latest Computers we have in stock.
        </p>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-meta-item">
                            <ion-icon name="calendar-outline" aria-hidden="true"
                                role="img" class="md hydrated"></ion-icon>
